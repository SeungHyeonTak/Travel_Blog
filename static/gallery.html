...
<html lang="zxx">
<head>
    <title>Camping a Travel Category Bootstrap Responsive Template | Gallery :: W3layouts</title>
    <!-- Meta tag Keywords -->
       ...
       <!-- header -->
        <header class="header">
            <div class="container">
                ...
                <nav class="py-3">
                    <div id="logo">
                        <h1> <a class="navbar-brand" href="index.html">Camping</a>
                        </h1>
                    </div>
    ...
    <section class="portfolio-flyer py-5" id="gallery">
        <div class="container pt-lg-3 pb-md-5">
            ...
            <div class="row news-grids pb-lg-5 mt-3 mt-lg-5">
                ...
                <div class="col-lg-4 gal-img mt-lg-4">
                    <div class="gal-info">
                        <a href="#gal8"><img src="images/8.jpg" alt="news image" class="img-fluid"></a>
                    </div>
                </div>
                <div class="col-lg-4 gal-img mt-lg-4">
                    <div class="gal-info">
                        <a href="#gal9"><img src="images/9.jpg" alt="news image" class="img-fluid"></a>
                    </div>
                </div>
            </div>
        </div>
